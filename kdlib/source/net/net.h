...
//    ULONG32  nameLen = 0;
//    HRESULT  hres = (obj->*method)(flags, bufferLength, &bufferLength, &buf.front() );
//
//    if ( hres == HRESULT_FROM_WIN32(ERROR_INSUFFICIENT_BUFFER) )
//    {
//        buf.resize(bufferLength);
//        hres = (obj->*method)(flags, bufferLength, &bufferLength, &buf.front() );
//    }
//
//    if (FAILED(hres))
//        return hres;
...
//HRESULT clrGetName(
//    T* obj,
//    HRESULT(STDMETHODCALLTYPE T::*method)( ULONG32, ULONG32*, WCHAR[]),
//    std::wstring & name
//    )
//{
//    name.clear();
...
//    std::vector<WCHAR>  buf(bufferLength);
//    ULONG32  nameLen = 0;
//    HRESULT  hres = (obj->*method)(bufferLength, &bufferLength, &buf.front() );
//
//    if ( hres == HRESULT_FROM_WIN32(ERROR_INSUFFICIENT_BUFFER) )
//    {
//        buf.resize(bufferLength);
//        hres = (obj->*method)(bufferLength, &bufferLength, &buf.front() );
//    }
//
//    if (FAILED(hres))
//        return hres;
